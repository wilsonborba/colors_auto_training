...
def generate_search_plan_route(plan_id: str) -> JSONResponse:
    return _to_http(generate_plan(plan_id))
...
def approve_search_plan_route(plan_id: str) -> JSONResponse:
    return _to_http(approve_plan(plan_id))
